            ...
            <div className="flex gap-6 text-sm">
                {navItems.map(({ name, path }) => (
                    <NavLink 
                        ...
                        to={path} 
                        className={({ isActive }) => 
                            `relative pb-1 text-lg ${isActive ? "text-primary font-medium after:absolute after:content-[''] after:h-1 after:rounded-lg after:bg-primary after:w-1/2 after:left-1/2 after:top-full after:-translate-x-1/2" : "hover:text-gray-600"}`
                        }
                    >
                        {name}
                    </NavLink>
                ...
                <div className={"flex items-center gap-1 group font-medium text-lg cursor-pointer hover:text-gray-600"}>
