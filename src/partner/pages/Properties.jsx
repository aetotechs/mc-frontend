    ...
    <div className='h-screen'>
      ...
      <section className='px-[8vw] py-[2vw] flex justify-between'>
        ...
        <section className='flex gap-4'>
            <article className='flex items-center border rounded-lg'>
                <Search01Icon size={28} className='p-2' onClick={() => {console.log("Triger search event here")}}/>
      ...
      <section className={`${data.length > 0 && "hidden"} px-[8vw] py-[2vw] h-56 flex items-center justify-center`}>
        <article className=''>
            ...
            <p className='text-md text-center text-gray-500'>Click <a href="/new" className='text-primary'>'+ New'</a> to get started</p>
        </article>
      </section>
