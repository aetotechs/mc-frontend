...
import MobileDetails from "../../components/client/details/MobileDetails";
  ...
  return (
    <div className="relative h-screen overflow-auto">
      ...
      <section className="hidden md:block">
        ...
        <section className="px-[8vw] block" ref={sectionsRef["Location"]}>
      ...
      <MobileDetails property={property}/>
