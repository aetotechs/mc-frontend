    ...
    <div className="flex justify-between px-[8vw] py-2.5">
      ...
      <div>
        <ul className="flex gap-5 items-center">
          ...
          <li className="relative group border rounded-[40px] flex items-center gap-1 px-3 py-1 border-[#CDCED7]">
            <span>
              <CircleUserRound className="h-5 w-5" />
            </span>
            <span>Account</span>

            <div className="absolute hidden group-hover:flex flex-col w-48 text-sm bg-white text-black rounded-md px-2 py-1 top-[50px] z-30 left-1/2 transform -translate-x-1/2 shadow-md">
