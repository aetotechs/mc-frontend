...
const AccountSettings = () => {
  return (
    <div className="relative h-screen overflow-auto">
      ...
      <section className="border-b pb-3 px-[8vw] my-10">
        <span className="text-xl font-semibold text-[#000000E5]">Account</span>
      </section>

      <section className="grid grid-cols-2 px-[8vw] gap-5">
        <div className="border col-span-2 py-6 flex justify-between px-3 border-[#D8D9E0] rounded-xl">
          <div></div>
        ...
        <div className="flex items-center gap-1">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[#62636C]">Securely manage your preferred payment methods.</span>
            </div>
          </div>
          <div>
            <Button className="bg-[#2F91D7] text-white text-sm p-1 gap-1">
        ...
        <div className="flex items-center gap-1">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[#62636C]">All your important updates in one place.</span>
            </div>
          </div>
